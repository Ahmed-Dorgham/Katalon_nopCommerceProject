...
WebUI.setText(findTestObject('Object Repository/RegisterationPageObjects/confirm_password_field'), GlobalVariable.validPassword)

WebUI.click(findTestObject('RegisterationPageObjects/register_btn'))

WebUI.verifyElementVisible(findTestObject('RegisterationPageObjects/registeration_successful_msg'))
