...
WebUI.setText(findTestObject('Object Repository/LoginPageObjects/password_field'), GlobalVariable.validPassword)

WebUI.click(findTestObject('Object Repository/LoginPageObjects/login_btn'))

WebUI.verifyElementPresent(findTestObject('Object Repository/LoginPageObjects/invalid_email_error_msg'), GlobalVariable.verifyTimeOut, 
