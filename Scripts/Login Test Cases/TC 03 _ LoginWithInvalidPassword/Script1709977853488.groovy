...
WebUI.setText(findTestObject('Object Repository/LoginPageObjects/email_field'), GlobalVariable.email)

WebUI.setText(findTestObject('Object Repository/LoginPageObjects/password_field'), GlobalVariable.invalidPassword)

WebUI.click(findTestObject('Object Repository/LoginPageObjects/login_btn'))

WebUI.verifyElementPresent(findTestObject('Object Repository/LoginPageObjects/invalid_password_error_msg'), GlobalVariable.verifyTimeOut, 
